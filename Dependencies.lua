...
IncludeDir["MONO"]					= "%{wks.location}/Uge/thirdparty/mono/include"
IncludeDir["FILEWATCH"]    			= "%{wks.location}/Uge/thirdparty/filewatch"
...
LibraryDir["MONO"]					= "%{wks.location}//Uge/thirdparty/mono/lib/%{cfg.buildcfg}"
